 ...
 * Page class
 */
class PacientesDelete extends Pacientes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PacientesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PacientesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PacientesList"); // Return to list
                return;
            }
        }
