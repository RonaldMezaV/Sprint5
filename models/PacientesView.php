 ...
 * Page class
 */
class PacientesView extends Pacientes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PacientesView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_paciente") ?? Route("id_paciente")) !== null) {
            $this->RecKey["id_paciente"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_paciente") ?? Route("id_paciente")) !== null) {
                ...
                $this->RecKey["id_paciente"] = $this->id_paciente->QueryStringValue;
            } elseif (Post("id_paciente") !== null) {
                $this->id_paciente->setFormValue(Post("id_paciente"));
                $this->RecKey["id_paciente"] = $this->id_paciente->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->id_paciente->setQueryStringValue($keyValue);
                $this->RecKey["id_paciente"] = $this->id_paciente->QueryStringValue;
            } else {
                $returnUrl = "PacientesList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PacientesList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "PacientesList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
