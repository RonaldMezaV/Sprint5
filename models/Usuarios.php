...
class Usuarios extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id_usuario
        $this->id_usuario = new DbField('usuarios', 'usuarios', 'x_id_usuario', 'id_usuario', '`id_usuario`', '`id_usuario`', 3, 11, -1, false, '`id_usuario`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        $this->id_usuario->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->id_usuario->Param, "CustomMsg");
        $this->Fields['id_usuario'] = &$this->id_usuario;

        // usuario
        $this->usuario = new DbField('usuarios', 'usuarios', 'x_usuario', 'usuario', '`usuario`', '`usuario`', 200, 50, -1, false, '`usuario`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // clave
        $this->clave = new DbField('usuarios', 'usuarios', 'x_clave', 'clave', '`clave`', '`clave`', 200, 50, -1, false, '`clave`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->clave->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->clave->Param, "CustomMsg");
    ...
    {
        global $Language;
        if ($pageName == "UsuariosView") {
            return $Language->phrase("View");
        } elseif ($pageName == "UsuariosEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "UsuariosAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("UsuariosView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("UsuariosView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "UsuariosAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "UsuariosAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("UsuariosEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UsuariosAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("UsuariosDelete", $this->getUrlParm());
    }
    ...
    public function keyUrl($url, $parm = "")
    {
        if ($this->id_usuario->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->id_usuario->CurrentValue);
        } else {
