...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'mIk0uI2n6y4Ap80m', // Random key for encryption
    ...
    "ADMIN_USER_NAME" => "rom", // Administrator user name
    "ADMIN_PASSWORD" => "123", // Administrator password
