...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?= BasePath() ?>/signofhealth_medical_10742.ico">
<link rel="icon" type="image/x-icon" href="<?= BasePath() ?>/signofhealth_medical_10742.ico">
